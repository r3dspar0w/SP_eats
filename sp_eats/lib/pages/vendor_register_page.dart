...
class _VendorRegisterPageState extends State<VendorRegisterPage> {
  ...
  Future<void> _onNext() async {
    ...
    try {
      await AuthService().registerVendor(email: email, password: pw);

      if (!mounted) return;
      _snack("Registered. Please submit verification details.", seconds: 3);

      Navigator.pushReplacementNamed(context, '/vendor_verify');
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  "Create an account to list your stall on SP Eats.",
                  style: GoogleFonts.manrope(
                    fontSize: 13,
  ...
  InputDecoration _lineDec({
    ...
    return InputDecoration(
      ...
      focusedBorder: const UnderlineInputBorder(
        borderSide: BorderSide(color: kPink, width: 1.6),
      ),
